...
E3F7<-E3F7[-1,]
E3F7
barplot(E3F7,beside = TRUE,main="Average monthly income per            
        capita",col=c("red","pink"),legend=rownames(E3F7))
```
...
E3D1<-E3D1[-1,]
E3D1
barplot(E3D1,beside = TRUE,main="Average weekly fuel  
        fee",col=c("lightgreen","darkgreen"),legend=rownames(E3D1))
```
